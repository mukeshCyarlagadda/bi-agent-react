...
import {
  ...
  ArrowRight, MessageSquare, Mail, Phone, Globe,
} from 'lucide-react'

/* ── Brand SVG logos — currentColor so they inherit amber tint ──────────────── */
        ...
        <div className="glass-panel mx-auto max-w-lg overflow-hidden">
          ...
          <div className="divide-y px-8 py-2" style={{ borderColor: 'oklch(1 0 0 / 0.06)' }}>
            {[
              ...
              { icon: LinkedInLogo, label: 'LinkedIn', value: 'mukesh-chandra-yarlagadda',  href: 'https://linkedin.com/in/mukesh-chandra-yarlagadda' },
              { icon: GitHubLogo,  label: 'GitHub',   value: 'mukeshCYarlagadda',           href: 'https://github.com/mukeshCYarlagadda' },
